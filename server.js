...
var articles={
    'article-one':{
        title:' Article-one This is harsha',
        heading:' Article-one',
        date: 'MAy 1 1996',
        content:` <p>
...
app.get('/:articleName',function(req,res){
    ...
    var articleName=req.params.articleName;//express framework
...
app.get('/ui/SRIHARSHA.png', function (req, res) {
  res.sendFile(path.join(__dirname, 'ui', 'SRIHARSHA.png'));
});
